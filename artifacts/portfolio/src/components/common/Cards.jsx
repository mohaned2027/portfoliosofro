...
export function CoverCard({ to, cover, eyebrow, title, meta, footer }) {
  const content = (
    <Card className="h-full flex flex-col">
      ...
      <div className="flex flex-1 flex-col gap-2 p-5">
        <h3 className="font-display text-lg font-semibold leading-tight line-clamp-2 group-hover:text-electric transition">
          {title}
        </h3>
