...
const __PageComponent = () => (
    <CrudPage
      ...
      api={api.researches       }
      columns={[
        { key: "title", label: "Title", render: (r     ) => <span className="font-medium text-foreground line-clamp-1">{r.title}</span> },
        { key: "year", label: "Year" },
        { key: "journal", label: "Journal" },
        { key: "doi", label: "DOI", render: (r     ) => <span className="font-mono text-xs">{r.doi}</span> },
      ]}
      fields={[
